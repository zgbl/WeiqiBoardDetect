...
# python /Users/tuxy/Codes/AI/WeiqiBoardDetect/AI_CornerDetect/Mac/test_hybrid.py --img /Users/tuxy/Codes/AI/Data/EmptyBoard/EmptyBoard3.jpg
...
def main():
    ...
    scanner = HybridScanner(args.weights, debug_show=True)
